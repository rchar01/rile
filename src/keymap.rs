...
pub fn default_bindings() -> Vec<KeyBinding> {
    ...
    vec![
        ...
        KeyBinding::new(
            [KeyEvent::Ctrl('h'), KeyEvent::Text("c".to_owned())],
            DescribeKeyBriefly,
        ),
        KeyBinding::new(
        ...
        KeyBinding::new(
            [KeyEvent::Ctrl('h'), KeyEvent::Text("m".to_owned())],
            DescribeMode,
        ),
        KeyBinding::new(
...
mod tests {
    ...
    fn resolves_single_key_bindings() {
        ...
        assert_eq!(
            keymap.resolve(&[KeyEvent::Meta(';')]),
            KeyResolution::Command(CommentDwim)
        );
        assert_eq!(
    ...
    fn resolves_prefix_and_complete_binding() {
        ...
        assert_eq!(
            keymap.resolve(&[KeyEvent::Ctrl('h'), KeyEvent::Ctrl('a')]),
            KeyResolution::Command(AboutRile)
        );
        assert_eq!(
        ...
        assert_eq!(
            keymap.resolve(&[KeyEvent::Ctrl('h'), KeyEvent::Text("c".to_owned())]),
            KeyResolution::Command(DescribeKeyBriefly)
        );
        assert_eq!(
        ...
        assert_eq!(
            keymap.resolve(&[KeyEvent::Ctrl('h'), KeyEvent::Text("m".to_owned())]),
            KeyResolution::Command(DescribeMode)
        );
        assert_eq!(
